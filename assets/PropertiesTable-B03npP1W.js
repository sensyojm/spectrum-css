import{ao as s,ay as N,an as w,al as t,az as ue,aA as ce,aB as O,p as Q}from"./index-6DZ5BdRV.js";const de=s.section`
...
`,pe=`<svg viewBox="0 0 36 36" focusable="false" aria-hidden="true" aria-label="AdobeLogo">
...
`,ne=`<svg focusable="false" aria-hidden="true" aria-label="GitHub" viewBox="0 0 36 36">
    <path fill="rgb(0, 0, 0)"
...
`,ve=({term:e,children:a})=>t.createElement(t.Fragment,null,t.createElement(M,null,t.createElement(ee,{style:{display:"inline-block"}},e)),t.createElement(H,null,a)),xe=s.span(({variant:e="positive",...a})=>`
	border-radius: 50%;
...
`,ye=s.div`
	margin-inline: 16px;
`,R=({tag:e,data:a={},isDeprecated:u=!1,skipDate:r=!1,skipLink:d=!1})=>{let c="notice",b="Not yet available on the npm registry.";return u?(c="negative",b="Deprecated; no longer maintained."):a.date&&(c="positive",b="Available on the npm registry."),!u&&e!=="latest"&&(c="notice",b="Available on the npm registry but not recommended for production use."),e==="local"&&(c="negative",b="Not yet published to the npm registry."),t.createElement(t.Fragment,null,t.createElement(xe,{variant:c,title:b}),!d&&a.link?t.createElement("a",{href:a.link,rel:"noopener noreferrer"},a.version):a.version,!r&&a.date?` ${a.date}`:"")};function ae(e,a){var n,m,g,o,v,y,x,z,j,q,C,F,A,L,$,S,P,U,W;const u="https://www.npmjs.org/package/",r=((g=(m=(n=e==null?void 0:e.csfFile)==null?void 0:n.meta)==null?void 0:m.parameters)==null?void 0:g.packageJson)??{},d=((y=(v=(o=e==null?void 0:e.csfFile)==null?void 0:o.meta)==null?void 0:v.parameters)==null?void 0:y.ignoredTags)??[],c=["local",...Object.keys((a==null?void 0:a["dist-tags"])??{})].filter(l=>!d.includes(l)),b=new Map;for(const l of c){let h=(j=(z=a==null?void 0:a.versions)==null?void 0:z[(x=a==null?void 0:a["dist-tags"])==null?void 0:x[l]])==null?void 0:j.version,f=(C=a==null?void 0:a.time)!=null&&C[(q=a==null?void 0:a["dist-tags"])==null?void 0:q[l]]?"published "+new Date((A=a==null?void 0:a.time)==null?void 0:A[(F=a==null?void 0:a["dist-tags"])==null?void 0:F[l]]).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"2-digit"}):null;const E=(L=a==null?void 0:a["dist-tags"])!=null&&L[l]?`${u}${r.name}/v/${($=a==null?void 0:a["dist-tags"])==null?void 0:$[l]}`:null;l==="local"&&(h=r==null?void 0:r.version,f="unpublished"),b.set(l,{version:h,date:f,link:E})}const i=[...b.entries()].sort(([l,h],[f,E])=>l==="local"?-1:f==="local"?1:l==="latest"?-1:f==="latest"?1:new Date(E.date)-new Date(h.date));if(c.includes("local")&&c.includes("latest")){const l=(P=(S=i.find(([f])=>f==="local"))==null?void 0:S[1])==null?void 0:P.version,h=(W=(U=i.find(([f])=>f==="latest"))==null?void 0:U[1])==null?void 0:W.version;if(l&&h&&l===h)i.splice(i.findIndex(([f])=>f==="local"),1);else if(l&&h&&l!==h){const f=l.split("."),E=h.split("."),Y=parseInt(f[0]),J=parseInt(E[0]);if(Y<J)i.splice(i.findIndex(([T,_])=>T==="local"),1);else if(Y===J){const T=parseInt(f[1]),_=parseInt(E[1]);if(T<_)i.splice(i.findIndex(([I,K])=>I==="local"),1);else if(T===_){const I=parseInt(f[2]),K=parseInt(E[2]);I<K&&i.splice(i.findIndex(([re,qe])=>re==="local"),1)}}}}return{showLocalVersion:i.find(([l])=>l==="local"),allVersions:i}}function ze(e){const[a,u]=w.useState(JSON.parse(localStorage.getItem(e))??{});return w.useEffect(()=>{try{localStorage.setItem(e,JSON.stringify(a))}catch{}},[e,a]),[a,u]}function te(e,a,u){const[r,d]=ze(e);w.useEffect(()=>{if(typeof r=="object"&&Object.keys(r).length>0){a(r),u(!1);return}fetch("https://registry.npmjs.org/"+e).then(async c=>{if(!c.ok){console.warn(`Failed to fetch npm data for ${e}`);return}const b=await c.json();if(!b){console.warn(`Failed to fetch npm data for ${e}`);return}a(b),d(b),u(!1)}).catch(c=>{console.warn((c==null?void 0:c.message)??c)})},[r,d,e,a,u])}const je=e=>{switch(e){case"npm":return me;case"GitHub":return ne;case"Adobe":return pe;case"WC":return ge}},V=({heading:e,alt:a,logo:u,href:r})=>{if(r)return t.createElement(ke,{href:r,className:"sb-unstyled",title:a},t.createElement(we,{dangerouslySetInnerHTML:{__html:je(u)}}),t.createElement(ye,null,e?t.createElement(Z,{size:"xs"},e):"",a?t.createElement(D,{size:"s"},a):""))},Ee=({packageName:e,spectrumData:a=[],rootClassName:u,isDeprecated:r})=>{var b,i,p,n,m,g;if(!e)return;let d,c;for(let o=0;o<(a==null?void 0:a.length);o++){const v=!((b=a[o])!=null&&b.rootClass)||((i=a[o])==null?void 0:i.rootClass)===u;(p=a[o])!=null&&p.guidelines&&v&&(c=(n=a[o])==null?void 0:n.guidelines),(m=a[o])!=null&&m.swc&&v&&(d=(g=a[o])==null?void 0:g.swc)}return t.createElement(he,{className:"sb-unstyled"},c?t.createElement(V,{className:"doc-block-resource-cards",heading:"Design guidelines",alt:"Spectrum website",logo:"Adobe",href:c}):"",d?t.createElement(V,{className:"doc-block-resource-cards",heading:"Web components",alt:"Spectrum web components",logo:"WC",href:d}):"",t.createElement(V,{className:"doc-block-resource-cards",heading:"View package",alt:"npm",logo:"npm",href:`https://npmjs.com/${e}`}),r?"":t.createElement(V,{className:"doc-block-resource-cards",heading:"View repository",alt:"GitHub",logo:"GitHub",href:`https://github.com/adobe/spectrum-css/tree/main/components/${e.split("/").pop()}`}))},Me=()=>{var o,v,y,x,z,j,q,C,F,A,L,$;const e=O("meta"),a=((x=(y=(v=(o=e==null?void 0:e.csfFile)==null?void 0:o.meta)==null?void 0:v.parameters)==null?void 0:y.status)==null?void 0:x.type)=="deprecated",u=((q=(j=(z=e==null?void 0:e.csfFile)==null?void 0:z.meta)==null?void 0:j.parameters)==null?void 0:q.packageJson)??{},r=((A=(F=(C=e==null?void 0:e.csfFile)==null?void 0:C.meta)==null?void 0:F.args)==null?void 0:A.rootClass)??"",d=u==null?void 0:u.name;if(!d)return;let c=u==null?void 0:u.spectrum;typeof c=="string"&&(c=[c]);const[b,i]=w.useState(!0),[p,n]=w.useState({});te(u.name,n,i);const{showLocalVersion:m,allVersions:g}=ae(e,p);return t.createElement(Q,null,b?"":t.createElement(t.Fragment,null,t.createElement(X,{className:"docblock-metadata sb-unstyled"},a?t.createElement(t.Fragment,null,t.createElement(M,{key:"status"},"Status:"),t.createElement(H,{key:"status-data"},"Deprecated")):"",m?t.createElement(t.Fragment,null,t.createElement(M,{key:"version-label"},"Local version:"),t.createElement(H,{key:"version"},t.createElement(R,{tag:"local",data:g&&((L=g.find(([S])=>S==="local"))==null?void 0:L[1]),isDeprecated:a}))):t.createElement(t.Fragment,null,t.createElement(M,{key:"version-label"},"Latest version:"),t.createElement(H,{key:"version"},t.createElement(R,{tag:"latest",data:g&&(($=g.find(([S])=>S==="latest"))==null?void 0:$[1]),isDeprecated:a,skipLink:!0})))),t.createElement(Ee,{packageName:d,spectrumData:c,rootClassName:r,isDeprecated:a})))},He=()=>{var p,n,m,g,o,v,y;const e=O("meta"),a=((g=(m=(n=(p=e==null?void 0:e.csfFile)==null?void 0:p.meta)==null?void 0:n.parameters)==null?void 0:m.status)==null?void 0:g.type)=="deprecated",u=((y=(v=(o=e==null?void 0:e.csfFile)==null?void 0:o.meta)==null?void 0:v.parameters)==null?void 0:y.packageJson)??{},[r,d]=w.useState(!0),[c,b]=w.useState({});te(u.name,b,d);const{allVersions:i}=ae(e,c);return t.createElement(Q,null,r?"":t.createElement(X,{skipBorder:!0,className:"docblock-releases sb-unstyled"},i.filter(([x])=>x!=="local").map(([x,z],j)=>t.createElement(ve,{key:`${x}-${j}`,term:x},t.createElement(R,{tag:x,data:z,isDeprecated:a,skipDate:!0})))))},{NAVIGATE_URL:Se}=__STORYBOOK_MODULE_CORE_EVENTS__,_e=()=>{var d,c,b,i,p,n;const e=w.useContext(N),a=O("meta"),u=((b=(c=(d=a==null?void 0:a.csfFile)==null?void 0:d.meta)==null?void 0:c.parameters)==null?void 0:b.packageJson)??{},r=((n=(p=(i=a==null?void 0:a.csfFile)==null?void 0:i.meta)==null?void 0:p.parameters)==null?void 0:n.metadata)??{};if(u!=null&&u.name&&!(!(r!=null&&r.modifiers)||!(r!=null&&r.modifiers.length)))return t.createElement(se,{color:"light",display:"contents"},t.createElement(fe,{id:"modifiable-properties",size:"m"},t.createElement("a",{"aria-hidden":"true",href:"#modifiable-properties",tabIndex:"-1",target:"_self",onClick:()=>{e.channel.emit(Se,"#modifiable-properties")}}),"Modifiable custom properties"),t.createElement(D,null,"These are empty CSS custom property hooks available in this component that enable one-off customizations specific to a product implementation."),t.createElement(be,{className:"docblock-properties-table sb-unstyled spectrum-Table spectrum-Table--sizeL spectrum-Table--compact"},t.createElement("thead",{className:"spectrum-Table-head"},t.createElement("tr",null,t.createElement("th",{className:"spectrum-Table-headCell"},"Property"))),t.createElement("tbody",{className:"spectrum-Table-body"},r==null?void 0:r.modifiers.map(m=>t.createElement("tr",{key:m,className:"spectrum-Table-row"},t.createElement("td",{className:"spectrum-Table-cell"},t.createElement(ee,{backgroundColor:"transparent",size:"s"},m)))))))};export{D as B,Me as C,Z as H,Fe as L,_e as P,Ae as S,He as T,Ve as a,Te as b,Le as c,$e as d,se as e,k as f};
