...
/**
 * By default, popovers do not have a tip and is positioned at the top. Popovers without a tip should be used when the source has a
 * visually distinct down state, in order to show the connection between the popover and its source.
 *
 * This example uses the [menu](?path=/docs/components-menu--docs) component within the popover, its position is `bottom`, and uses a button as the source.
 */
